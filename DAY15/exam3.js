...
if (visit == null) {
    sessionStorage.setItem('visit', counter);
} else {
    counter = parseInt(visit) + 1;
    sessionStorage.setItem('visit', counter);
}

const spanDom = document.querySelector('.방문');

let html = `이번 세션에서 ${counter}번째 방문입니다.`;
