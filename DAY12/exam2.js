...
// [매개변수] 무엇을 넣고 [명령어]무엇을처리 [반환값]무엇을 반환하지?
...
//     return `환영합니다, ${name}님`;
// }
// let result3=getWelcomeMessage(prompt("이름을 입력하세요"));
// console.log(result3);                //name이라는 매개변수를 리턴에 `환영합니다, ${name}님`;로 반환하기로 약속하여 이름을 입력하여 출력
...
//     }
// }
// printNumbers(Number(prompt("숫자를 입력하세요")));
...
//     }
// }
// isPositive(Number(prompt("숫자를 입력하세요")));
...
function printLocal(){
    let localText=`지역`;
    console.log(localText); //불가능
}
console.log(globalText);    //가능