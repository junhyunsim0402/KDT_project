...
// const inventory = { apple: 15, banana: 5, orange: 20, grape: 8 };
// let inven=Object.keys(inventory);
// for (let i=0;i<inven.length;i++){
//     if(inventory[inven[i]]<10){
//         console.log(inven[i]);
//     }
// }
...
[ 공공데이터 open API 신청 ]
  ...
  [1]공공데이터로 부터 신청한 자료 결과 복붙:https://api.odcloud.kr/api/3044322/v1/uddi:89061f01-5fd0-43e3-9aa3-8513be01cad5?page=1&perPage=10&serviceKey=4ee9be39b33128b90223f3a882e6ae3c210fa69d2c15156eda7335e4e2687bcc
  */
...
// let html=`<table>`;
// //[3]data안에 있는 요소 들을 반복문으로 순회
// for (let index=0;index<data.length;index++){
//   let row=data[index];
//   console.log(row);     //index번째 `동` 정보 확인
//   console.log(row.동별,row.세대수,row["인구수(계)"],row["인구수(남)"],row["인구수(여)"]);
//   //[4]객체 정보들을 테이블로 표현, 표=배열=table, 행=객체=<tr>,열=속성=<td>
//   html+=`<tr>
//   <td>${row.동별}</td>
//   <td>${row.세대수}</td>
//   <td>${row["인구수(계)"]}</td>
